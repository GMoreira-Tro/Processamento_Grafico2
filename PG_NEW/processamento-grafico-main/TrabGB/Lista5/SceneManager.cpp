...
void SceneManager::setupScene(string texturePath)
{
	...
	sprites[1]->textureID = loadTexture("../textures/enemy0.png");
	sprites[2]->textureID = loadTexture("../textures/enemy1.png");
	sprites[3]->textureID = loadTexture("../textures/enemy2.png");
	sprites[4]->textureID = loadTexture("../textures/enemy3.png");
	sprites[5]->textureID = loadTexture("../textures/enemy4.png");
